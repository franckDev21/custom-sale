      ...
      headerContent={
        <>
          <div className="ml-4 w-[70%] font-bold text-2xl text-[#ac3265] flex items-center justify-between">
           <span>| Ajouter un nouvelle utilisateur </span> 
          </div>
        </>
      }
    >
          ...
          <form onSubmit={handleSubmit} className="p-5 max-w-4xl mx-auto rounded-lg  bg-white relative">
            ...
            <div className="flex justify-between items-start space-x-4 mb-4">
              <div className=' flex-col flex w-1/2'>
                ...
                <input autoFocus required onChange={handleOnchange} name='firstname' value={user.firstname || ''} type="text" placeholder="Entrer le prénom de l'utilisateur" className='px-3 mt-2 rounded-md border-none focus:ring-2 ring-gray-700 focus:ring-gray-700 py-2 bg-gray-100 w-full' />
              </div>
              <div className=' flex-col flex w-1/2'>
                <label htmlFor="lastname">Nom</label>
                <input required onChange={handleOnchange} name='lastname' value={user.lastname || ''} type="text" placeholder='Entrer le prénom de le nom' className='px-3 mt-2 rounded-md border-none focus:ring-2 ring-gray-700 focus:ring-gray-700 py-2 bg-gray-100 w-full' />
              </div>
            </div>
            ...
            <div className="flex justify-between items-start space-x-4 mb-4">
              <div className=' flex-col flex w-1/2'>
                ...
                <input required onChange={handleOnchange} name='email' value={user.email || ''} type="email" placeholder="Email de l'utilisateur" className='px-3 mt-2 rounded-md border-none focus:ring-2 ring-gray-700 focus:ring-gray-700 py-2 bg-gray-100 w-full' />
              </div>
              <div className=' flex-col flex w-1/2'>
                <label htmlFor="tel">Téléphone</label>
                <input required onChange={handleOnchange} name='tel' value={user.tel || ''} type="tel" placeholder='Numéro de téléphone ...' className='px-3 mt-2 rounded-md border-none focus:ring-2 ring-gray-700 focus:ring-gray-700 py-2 bg-gray-100 w-full' />
              </div>
            </div>

            <div className="flex justify-between items-start space-x-4">
              <div className=' flex-col flex w-1/2'>
                <label htmlFor="firstname" className='mb-2'>Mot de passe</label>
                <div className="relative inline-block">
                  <input required ref={inputPassword} onChange={handleOnchange} name='password' value={user.password || ''} type="password" placeholder="mot de passe de l'utilisateur" className='px-3 inline-block rounded-md border-none focus:ring-2 ring-gray-700 focus:ring-gray-700 py-2 bg-gray-100 w-full' />
                  <span onClick={_=>{
              ...
              <div className=' flex-col flex w-1/2'>
                <label htmlFor="firstname" className='mb-2'>Confirmer le mot de passe</label>
                <div className="relative inline-block">
                  <input required ref={inputPassword2} onChange={handleOnchange} name='password_confirmation' value={user.password_confirmation || ''} type="password" placeholder="Confirmation du mot de passe" className='px-3 inline-block rounded-md border-none focus:ring-2 ring-gray-700 focus:ring-gray-700 py-2 bg-gray-100 w-full' />
                  <span onClick={_=>{
            ...
            <div className="flex items-center justify-start mt-3 mb-1">
                ...
                <label htmlFor="active" className="text-gray-500 cursor-pointer">Voulez-vous directement activer l'utilisateur a sa création ?</label>
            </div>
            ...
            <div className="flex items-center justify-end">
              <button type='submit' className={`px-4 ${sending && 'disabled'} flex justify-center items-center py-[0.48rem] bg-[#ac3265] hover:bg-[#951f50] transition min-w-[200px] text-white text-sm font-semibold rounded-md`}>
                {sending ? <Loader className=' inline-block text-xl' /> : "Enregister l'utilisateur"}
              </button>
            </div>
          </form>
          }
