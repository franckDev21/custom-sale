...
const Company: FC<TypeCompany> = () => {
  ...
  return (
    <DashboardLayout
      title={`${
        action === "create" ? "Créer une entreprise" : "Mon entreprise"
      }`}
      headerContent={
        <>
          <div
            className={`ml-4 ${
              action === "create" ? "w-[70%]" : "w-[80%]"
              ...
              <>
                ...
                <div className="flex items-center justify-end">
                  ...
                  <button className="flex text-lg  justify-start border-4 items-center space-x-2 rounded px-2 py-1 text-gray-700 bg-gray-50 w-auto ml-3">
                    ...
                    <span className="pl-1">
                      {" "}
                      {dashboardInfo.totalProduct} Product(s)
                    </span>
                  </button>
                </div>
              </>
            ...
            <div className="min-h-[24rem]  rounded-lg border-4 border-dashed border-gray-300 bg-white relative">
              {!editing && (
                <button
                  ...
                  className="bg-gray-700 flex justify-center items-center text-white text-xl absolute right-2 top-2 p-3 rounded-md shadow-md"
                >
                  <BsPencilSquare />
                </button>
              )}
              ...
              {editing && (
                ...
                >
                  <button
                    type="submit"
                    className={`bg-green-500 font-bold mr-1 text-white uppercase ${
                      sending ? "px-3 py-2" : "p-3"
                    } rounded-md shadow-md text-sm`}
                  >
                    {sending ? (
                      <Loader className="inline-block text-lg mt-1" />
                    ) : (
                  ...
                  <button
                    onClick={(_) => setEditing(!editing)}
                    title="Click here to edit the company"
                    className="bg-gray-700  text-white text-xl p-3 rounded-md shadow-md"
                  >
                    <FaEye />
                  </button>
                </div>
                  ...
                  <div className="flex flex-wrap">
                    <div className="w-3/12">
                      <label
                        ...
                        } cursor-pointer inline-block bg-gray-50`}
                      >
                        ...
                        <div className="w-full lg:w-1/2 px-4">
                          <div className="relative w-full mb-3">
                            ...
                            <input
                              ...
                              name="name"
                              type="text"
                              className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring ring-gray-700 focus:ring-gray-700 w-full ease-linear transition-all duration-150"
                        ...
                        <div className="w-full lg:w-1/2 px-4">
                          <div className="relative w-full mb-3">
                            ...
                            <input
                              ...
                              type="email"
                              className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring ring-gray-700 focus:ring-gray-700 w-full ease-linear transition-all duration-150"
                              placeholder="info@microsoft.com"
                            />
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="w-full lg:w-1/2 px-4">
                          <div className="relative w-full mb-3">
                            ...
                            <input
                              ...
                              type="text"
                              className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring ring-gray-700 focus:ring-gray-700 w-full ease-linear transition-all duration-150"
                              placeholder="Combien d'employés avez-vous ?"
                            />
                          </div>
                        </div>
                        <div className="w-full lg:w-1/2 px-4">
