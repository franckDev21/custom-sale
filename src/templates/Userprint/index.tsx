    ...
    <Document>
      <Page wrap size="A4" style={styles.page}>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableTh}><Text>Email</Text></View>
          <View style={styles.tableTh}><Text>statut</Text></View>
          ...
          {users.map(item => (
            <React.Fragment key={item.id}>
              ...
              <View style={styles.tableChild}><Text>{item.email}</Text></View>
              <View style={styles.tableChild}><Text>{item.active ? 'Activif':'Inactif'}</Text></View>
